    ...
    <div class="container">
        <div class="d-flex flex-column align-items-center">
            ...
            <div class="rounded-circle border border-3 border-white overflow-hidden mb-3">
                <img src="{{ asset($user->profile_image ? 'img/' . $user->profile_image : 'img/user.jpg') }}" alt="Foto de perfil" class="img-fluid">
            </div>
            ...
            <form id="fotoForm" action="{{ route('user.update') }}" method="POST" enctype="multipart/form-data" style="display: none;">
                @csrf
                @method('PUT')
...
<script>
    ...
    // Al hacer click en "Subir foto" del encabezado, se activa el input de archivo del formulario oculto
